        ...
        return (
            <div className="Header">
                ...
                <div className="row d-flex h-100">
                    <div className="col-8 col-sm-2 col-md-2 col-lg-2 col-xl-1 border">Logo</div>
                    <div className="d-none d-sm-block col-sm-3 col-md-3 col-lg-3 col-xl-2 border">History toggle</div>
                    <div className="d-none d-sm-block col-sm-5 col-md-5 col-lg-5 col-xl-7 border">Scrubbing bar</div>
