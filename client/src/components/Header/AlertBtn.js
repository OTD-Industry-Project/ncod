...
function AlertBtn() {
  ...
  return (
    <div>
      ...
      >
        <DialogTitle id="alert-dialog-title">{"Bus Alerts!"}</DialogTitle>
        <DialogContent>
          ...
          <Alert severity="warning">
            ...
            Driver Id - "Joseph" <br />
            Date - 01/01/2022 <br />
            Time Slot - 7:00PM - 8:20PM <br />
            Destination - "Geelong Adventure Park" <br />
          </Alert>
          <Alert severity="warning">
            ...
            Driver Id - "James" <br />
            Date - 01/01/2022 <br />
            Time Slot - 6:10PM - 7:10PM <br />
            Destination - "Bounce Inc" <br />
          </Alert>
        </DialogContent>
        <DialogActions>
